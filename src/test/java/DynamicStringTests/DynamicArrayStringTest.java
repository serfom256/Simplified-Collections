...
public class DynamicArrayStringTest {
    ...
    public void insertDynamicStringAtPos() {
        assertEquals("abc", string.insert(0, new DynamicArrayString("abc")).toString());
        assertEquals("abc123", string.insert(999, new DynamicArrayString("123")).toString());
        assertEquals("abc000123", string.insert(3, new DynamicArrayString("000")).toString());
        assertEquals("abc000q123", string.insert(6, new DynamicArrayString("q")).toString());
        assertEquals("abc000q12test3", string.insert(string.getSize() - 1, new DynamicArrayString("test")).toString());
    }
    ...
    public void indexOfDynamicString() {
        string.add("01234").add("56789");
        assertEquals(0, string.indexOf(new DynamicArrayString("012")));
        assertEquals(-1, string.indexOf(new DynamicArrayString("1111111111111111111111111111111111")));
        assertEquals(-1, string.indexOf(new DynamicArrayString()));
        assertEquals(-1, string.indexOf(new DynamicArrayString("654")));
        assertEquals(0, string.indexOf(new DynamicArrayString("0123456789")));
        assertEquals(5, string.indexOf(new DynamicArrayString("567")));
        assertEquals(9, string.indexOf(new DynamicArrayString("9")));
        assertEquals(-1, string.indexOf(new DynamicArrayString("9999")));
        assertEquals(-1, string.indexOf(new DynamicArrayString("678910")));
    }
    ...
    public void startsWith() {
        ...
        assertFalse(string.startsWith(new DynamicArrayString(" ")));
        string.add("98765");
        ...
        assertTrue(string.startsWith(new DynamicArrayString("98765")));
        assertFalse(string.startsWith(new DynamicArrayString("987650")));
    }
    ...
    public void endsWith() {
        ...
        assertFalse(string.endsWith(new DynamicArrayString(" ")));
        string.add("98765");
        ...
        assertTrue(string.endsWith(new DynamicArrayString("98765")));
        assertTrue(string.endsWith(new DynamicArrayString("765")));
        assertFalse(string.endsWith(new DynamicArrayString("987650")));
    }
    ...
    public void equals() {
        string.add("01234").add("56789");
        assertEquals(new DynamicArrayString("0123456789"), string);
        assertEquals("0123456789", string.toString());
        assertNotEquals(new Object(), string.equals(new Object()));
        assertNotEquals(null, string);
        assertNotEquals(new DynamicArrayString("012345678"), string);
    }
    ...
    public void clear() {
        ...
        string.clear();
        assertEquals(0, string.getSize());
        string = new DynamicArrayString("abc");
