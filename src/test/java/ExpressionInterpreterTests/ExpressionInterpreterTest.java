...
public class ExpressionInterpreterTest {
    ...
    public void calculateExpressionTest() {
        ...
        assertEquals("-1", interpreter.calculate("-2-1+2"));
        assertEquals("45", interpreter.calculate("64/2 + 153/11"));
        assertEquals("105", interpreter.calculate("108/2 +(306 /6)"));
        assertEquals("14063393908530", interpreter.calculate("12345678*(1234567-99999+4567)"));
        assertEquals("2278270", interpreter.calculate("12345678*(1234567-99999+4567)/12345678*2"));
        assertEquals("8", interpreter.calculate("4*(3-2+1)"));
    }
